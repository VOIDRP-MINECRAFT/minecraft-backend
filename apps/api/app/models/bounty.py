...
class Bounty(UuidPrimaryKeyMixin, ServerScopedMixin, TimestampMixin, Base):
    ...
    # "player" = pledged by a player (diamonds escrowed by the mod); "server" =
    # auto-generated by the notoriety/"wanted" system (server-funded reward).
    source: Mapped[str] = mapped_column(String(16), nullable=False, default="player")
